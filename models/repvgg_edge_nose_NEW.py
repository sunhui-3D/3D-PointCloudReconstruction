...
def edge_conv2d(im):
    ...
    # print(type(conv_op.weight.data))
    # print(conv_op.weight.size())
    # print(conv_op, '\n')

    edge_detect = conv_op(im)
    # print(edge_detect.device)
    # print(type(edge_detect))
    # print(edge_detect.shape)
    # torch.transpose(edge_detect,1,2,0)
    # edge_detect.permute(1,2,0)
    # print(edge_detect.shape)
...
def create_RepVGG_A2(deploy=False):
    ...
    model.load_state_dict(torch.load('/home/chenwenyu/3D-BTPCNet/pretrained_models/RepVGG-A2-train.pth'))
